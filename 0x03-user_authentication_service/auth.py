...
class Auth:
    ...
    def create_session(self, email: str) -> str:
        """ Creates a session id, assigns it to a user
            in the database and returns it as string
        """
    ...
    def get_user_from_session_id(self, session_id: str) -> User:
        """ Returns a user object based on the session_id """
    ...
    def update_password(self, token: str, password: str) -> None:
        """ finds a user with the rset_token string passed
            and updates the corresponding user password to the
            passed password
        """
